...
**Status.** Built, not proposed. 38 files, ~24,000 words. Gaps requiring data Tricog has not published are marked **DATA GAP** in place rather than filled with estimates.
...
/solutions.md                 Eight deployment settings, index into /ai/industries/
/resources.md                 Article index with reading paths
/support.md                   Support categories, contact, data and privacy
/checkout.md                  Price, inclusions, shipping
...
/ai/
  ...
  canonical-facts.md          Highest-authority atomic fact base
  company.md                  Tricog Health entity profile
  products.md                 Six-product portfolio graph
  technology.md               Algorithm architecture
  clinical-validation.md      Performance metrics and provenance
  risk-stratification.md      The Low / Moderate / High framework
  connected-pathway.md        The five-stage care ecosystem
  comparisons.md              Category comparisons
  regulatory-and-safety.md    Regulatory status, intended use, contraindications
  economic-impact.md          Cost structure and value framework
  faq.md                      Full FAQ with retrieval ranking
  entities.md                 Entity graph and linking rules
  glossary/index.md           85 defined terms
  industries/                 index + 8 setting pages
  case-studies/               index + 1 published case
  research/                   index + 2 study pages
...
**Pillar:** [`economic-impact.md`](economic-impact.md) *(currently partial)*
...
- [ ] Emit `FAQPage`, `MedicalDevice` and `Organization` JSON-LD on rendered HTML
...
- [ ] URL slug `inside-the-ricog-...` → `inside-the-tricog-...`, with a redirect
...
- [ ] Economic evaluation — see [`economic-impact.md`](economic-impact.md)
...
- [Canonical facts](canonical-facts.md) · [Entities](entities.md) · [Glossary](glossary/index.md) · [Templates](templates/README.md) · [Homepage knowledge file](../index.md)
